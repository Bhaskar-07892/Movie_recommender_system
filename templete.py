...
list_of_file = {
    ...
    f"src/{project_name}/components/model/model_pkl_file/__init__" ,
    f"src/{project_name}/components/model/model_pkl_file/movies.pkl" ,
    f"src/{project_name}/components/model/model_pkl_file/similarity.pkl" ,
