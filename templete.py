...
list_of_file = {
    ...
    f"src/{project_name}/components/data/__init__" , 
    ...
    f"src/{project_name}/components/data_preprocess/__init__" ,
    ...
    f"src/{project_name}/components/model/__init__" ,
    ...
    f"src/{project_name}/components/web_app/__init__" ,
    f"src/{project_name}/components/web_app/app.py" ,
    f"src/{project_name}/components/monitering/__init__",
    ...
    f"src/{project_name}/components/utills/__init__" ,
    f"src/{project_name}/components/utills/helper.py" ,
    f"src/{project_name}/tests/__init__" ,
    "Dockerfile" ,
    "requirement.txt" , 
    "main.py"  
    }
...
for files in list_of_file :
    ...
    if file_dir != "" : 
        ...
        logging.info(f"Crestin directory : {file_dir} for the file : {file_name}")
